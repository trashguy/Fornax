...
/// lives in percpu.AsmState, accessed via TP-relative in entry.S.
///
...
/// On SMP, writes to the current core's percpu AsmState only.
/// SSCRATCH is set by trap_return (U-mode return path), not here.
