...
pub const cntr_start = syscall.cntr_start;
pub const cntr_stop = syscall.cntr_stop;
pub const cntr_destroy = syscall.cntr_destroy;
pub const cntr_exec = syscall.cntr_exec;
pub const CNTR_START = syscall.CNTR_START;
pub const CNTR_STOP = syscall.CNTR_STOP;
pub const CNTR_DESTROY = syscall.CNTR_DESTROY;
pub const CNTR_EXEC = syscall.CNTR_EXEC;
pub const CNTR_NETD = syscall.CNTR_NETD;
pub const cntr_netd = syscall.cntr_netd;
